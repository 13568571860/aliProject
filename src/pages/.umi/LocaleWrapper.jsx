...
const localeInfo = {
  'en-US': {
    messages: {
      ...require('/project/demo/myDemo/src/locales/en-US.js').default,
    },
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: {
      ...require('/project/demo/myDemo/src/locales/pt-BR.js').default,
    },
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: {
      ...require('/project/demo/myDemo/src/locales/zh-CN.js').default,
    },
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: {
      ...require('/project/demo/myDemo/src/locales/zh-TW.js').default,
    },
    locale: 'zh-TW',
