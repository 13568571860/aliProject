...
import RendererWrapper0 from '/project/demo/myDemo/src/pages/.umi/LocaleWrapper.jsx'
...
let routes = [
  ...
  LoadingComponent: require('/project/demo/myDemo/src/components/PageLoading/index').default,
}),
    "routes": [
      {
        "path": "/user",
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__User__models__register.js' */'/project/demo/myDemo/src/pages/User/models/register.js').then(m => { return { namespace: 'register',...m.default}})
],
...
models: () => [
  ...
  LoadingComponent: require('/project/demo/myDemo/src/components/PageLoading/index').default,
      ...
      {
        "component": () => React.createElement(require('/project/demo/myDemo/node_modules/umi-build-dev/lib/plugins/404/NotFound.js').default, { pagesPath: 'src/pages', hasRoutesInConfig: true })
      }
    ]
  },
  {
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Dashboard__models__activities.js' */'/project/demo/myDemo/src/pages/Dashboard/models/activities.js').then(m => { return { namespace: 'activities',...m.default}}),
  import(/* webpackChunkName: 'p__Dashboard__models__chart.js' */'/project/demo/myDemo/src/pages/Dashboard/models/chart.js').then(m => { return { namespace: 'chart',...m.default}}),
  import(/* webpackChunkName: 'p__Dashboard__models__monitor.js' */'/project/demo/myDemo/src/pages/Dashboard/models/monitor.js').then(m => { return { namespace: 'monitor',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Forms__models__form.js' */'/project/demo/myDemo/src/pages/Forms/models/form.js').then(m => { return { namespace: 'form',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__List__models__rule.js' */'/project/demo/myDemo/src/pages/List/models/rule.js').then(m => { return { namespace: 'rule',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Profile__models__profile.js' */'/project/demo/myDemo/src/pages/Profile/models/profile.js').then(m => { return { namespace: 'profile',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Exception__models__error.js' */'/project/demo/myDemo/src/pages/Exception/models/error.js').then(m => { return { namespace: 'error',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Account__Settings__models__geographic.js' */'/project/demo/myDemo/src/pages/Account/Settings/models/geographic.js').then(m => { return { namespace: 'geographic',...m.default}})
],
        ...
        "routes": [
          {
            "path": "/editor1/fliow",
            "name": "one",
            "conponents": "./Editor/GGeditor/Flow",
            "exact": true
          },
          {
            "component": () => React.createElement(require('/project/demo/myDemo/node_modules/umi-build-dev/lib/plugins/404/NotFound.js').default, { pagesPath: 'src/pages', hasRoutesInConfig: true })
